...
app.listen(ENV.PORT, () => {
  ...
  // Then every 2 minutes
        ...
        // ОПТИМАЛЬНЫЙ ИНТЕРВАЛ каждые 5 минут для быстрого обновления
        setInterval(() => {
          console.log('⏰ АвтоСинхронизация каждые 5 минут...');
          runSync();
        }, 5 * 60 * 1000);
        
        // ДОПОЛНИТЕЛЬНАЯ ПРОВЕРКА каждые 2 минуты для максимальной надежности
        setInterval(() => {
