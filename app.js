...
app.listen(ENV.PORT, () => {
  ...
  // Then every 2 minutes
        ...
        // ИСПРАВЛЕНО: УБИРАЕМ ВНУТРЕННИЕ ИНТЕРВАЛЫ - VERCEL ИХ НЕ ПОДДЕРЖИВАЕТ
        console.log('🔧 ИСПРАВЛЯЮ ПРОБЛЕМУ: Vercel не поддерживает setInterval!');
        console.log('✅ БОТ РАБОТАЕТ ЧЕРЕЗ ВНЕШНИЕ ЗАПРОСЫ:');
        console.log('   🔗 https://testoraapp.vercel.app/api/sync-payments (POST)');
