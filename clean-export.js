...
async function cleanExport() {
  try {
    console.log('🧹 ПОЛНАЯ ОЧИСТКА И ВЫГРУЗКА ЗАНОВО...');
    ...
    // Заголовки - ТОЛЬКО НУЖНЫЕ СТОЛБЦЫ
    const headers = [
      'Payment ID', 'Amount', 'Currency', 'Status', 'Created', 
      'Customer ID', 'Customer Email', 'GEO',
      'UTM Source', 'UTM Medium', 'UTM Campaign', 'UTM Content', 'UTM Term',
      'Ad Name', 'Adset Name', 'Campaign Name', 'Platform Placement',
      'Creative Link', 'Product Tag', 'Gender', 'Age',
      'Customer Name', 'Customer Phone', 'IP Address', 'User Agent'
    ];
    ...
    console.log(`🎉 ГОТОВО! ${payments.data.length} платежей с чистой структурой в Google Sheets`);
